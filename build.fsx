...
module ProjectInfo = 
    ...
    let gitName = "BioFSharp.ImgP"

    let solutionFile = "BioFSharp.ImgP.sln"

    let gitHome = sprintf "%s/%s" "https://github.com" gitOwner

    let projectRepo = sprintf "%s/%s/%s" "https://github.com" gitOwner gitName

    let website = "/BioFSharp.ImgP"

    let testProject = "tests/BioFSharp.ImgP.Tests/BioFSharp.ImgP.Tests.fsproj"
